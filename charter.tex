...
\item Documentación. (128 hs)
	\begin{enumerate}
	\item camino critico marcado con tareas de color rojo y en trazo grueso de color negro. Un total de 348 hs.
...
Se puede ver el AON en la figura \ref{fig:AoN}:

\begin{figure}[htpb]
\centering 
\includegraphics[width=1.1\textwidth]{./Figuras/AONProyecto.pdf}
...
\begin{itemize}
	...
	\item El desarrollo de la aplicación marcado en azul puede demorarse hasta 94 hs respecto del camino critico.
	\item El desarrollo de las tareas de integración, testing del proyecto y verificación del proyecto marcado en verde puede demorarse hasta 36 hs respecto del camino critico.
...
\begin{figure}[htpb]
\centering 
\includegraphics[height=.17\textheight]{./Figuras/ganttProyecto.pdf}
...
\item El proyecto empieza el día 02/01/2024 y finaliza el 02/08/2024.
\item Se tomaron los grupos de tareas generales para confeccionar el diagrama, dado que las tareas internas al grupo de tareas son secuenciales, como por ejemplo  la Etapa de integración compuesta por las tareas ``Integración de software y harware"                                      ,``Pruebas generales de software y  hardware".
\end{itemize}
...
\multicolumn{1}{|l|}{Viaticos}  &
  \multicolumn{1}{c|}{154 d} &
  \multicolumn{1}{c|}{3000 \$} &
...
\item Materiales, se calculo el valor correspondiente placa perforada, protoboard, cables , microcontroladores y un 20 \% mas de estimación.
...
\item Viaticos, se considera el consumo de alimentos promedio en un dia.
